           ...
           <div className="container-fuid header d-flex justify-content-between p-3 d-lg-none">
                   ...
                   <a className="" href="#profile" onClick={handleAbout}>{about? <p className="text-white">ABOUT</p>: <p className="">ABOUT</p>}</a>
                    ...
                    <div className="reorder">
                       ...
                       {remove?<i className="fa fa-times" onClick={handleRemove}></i> : ' '}
                    </div>
           ...
           <div className="container-fluid">
               ...
               <div className="row">
                   <div className="col-sm-3 d-none d-lg-block small-view">
                      <img className="profile-image d-block mx-auto img-thumbnail mb-3" src={profile} alt="" />
                      <a className="" href="#profile" onClick={handleAbout}>{about? <p className="text-white">ABOUT</p>: <p className="">ABOUT</p>}</a>
                      <a className="" href="#projects" onClick={handleProject}>{project? <p className="text-white">PROJECTS</p>: <p className="">PROJECTS</p>}</a>
                      <a className="" href="#education" onClick={handleEdu}>{education? <p className="text-white">EDUCATION</p>: <p className="">EDUCATION</p>}</a>
                      <a className="" href="#skills" onClick={handleSkill}>{skill? <p className="text-white">SKILLS</p>: <p className="">SKILLS</p>}</a>
                   ...
                   <div className="col-sm-9 big-view">
                        ...
                        <p className="profile-text mb-5">I'm a web developer with ability to learn and collaborate in rapidly changing environments and compositions. </p>
                          ...
                          <p className="mb-5"><i className="fa fa-home"></i> <span className="pro-detail ">LAGOS, NIGERIA.</span></p>
                           ...
                           <div className="mb-5">
                              ...
                              <a className="mx-2" href="https://www.github.com/destinyifeh" target="_blank" rel="noreferrer noopener"> <i className="fa fa-github"></i></a>
                       ...
                       <h2 className="profile-title mb-5">EDUCATION</h2>
                         <h3 className="sub-title">University Of Benin</h3>
                          ...
                          <h3 className="sub-title mt-4">Dexplora Computer Institute And Technology</h3>
                       ...
                       <p className="">Apart from being a web developer, i enjoy most of my time being outdoors. I enjoy hanging out with friends and family.</p>
                        <p className="">When forced indoors,  I spend a large amount of my free time exploring the latest technology advancements in both front and back-end web development world, as well as exploring the latest happenings around the world. </p>
                       </div>
                       </div>
               </div>
           </div>
